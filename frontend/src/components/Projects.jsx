...
const Projects = ({path, url, alt, children, projectName, description}) => {
  return (
    <>
      <article className="group grid w-full place-content-center rounded-lg ">
        <picture className="relative overflow-hidden rounded-lg">
          <img
            ...
            alt={alt}
          />
          <a href={url} target="_blank" rel="noopener noreferrer" className="bg-gray-500 text-white absolute top-7 right-8 rounded-full py-2 px-4 hidden group-hover:block"><ArrowIcon className={"w-6 h-6 fill-white origin-center -rotate-45"}/></a>
