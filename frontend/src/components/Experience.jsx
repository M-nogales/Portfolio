...
const Experience = () => {
  return (
    <>
      ...
      <h2 className="text-textForeground text-3xl font-bold mb-4 flex gap-x-5 items-center"> <BriefcaseIcon className={"h-8"}/> Experience</h2>
        ...
        <ol className="relative border-s border-primary-900 dark:border-primary-950">
          {EXPERIENCE.map((experience, index) => (
            <li key={index} className="mb-10 ms-6">
              ...
              <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-textForeground">
                {experience.title}
              </h3>
